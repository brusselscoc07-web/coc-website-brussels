...
import { buildIcs, eventImage, events, location } from "@/lib/data";
    ...
    <div>
      <div className="relative flex h-[min(52vh,460px)] min-h-[320px] items-end overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${eventImage(event.id)})`, backgroundSize: "cover", backgroundPosition: "center" }}
        />
        <div
          className="absolute inset-0"
      ...
      <div className="mx-auto max-w-[900px] px-8 pb-20 pt-12">
        <div className="mb-10 grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4">
          <div className="rounded-2xl border border-border bg-white p-[22px]">
            ...
            <div className="text-[17px] font-semibold text-green-dark">{event.date}</div>
          </div>
          <div className="rounded-2xl border border-border bg-white p-[22px]">
            <div className="mb-2 text-[11px] tracking-[1.5px] text-gold uppercase">Time</div>
            <div className="text-[17px] font-semibold text-green-dark">{event.time}</div>
          </div>
          <div className="rounded-2xl border border-border bg-white p-[22px]">
        ...
        <div className="mb-10 text-[16px] leading-[1.9] text-ink-soft">{event.desc}</div>
